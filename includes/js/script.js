...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(a, b, c) {
                ...
                var d = function(a) {
                    ...
                    q = d.prototype = new b;
                return d.version = "1.18.4", q.constructor = d, q.kill()._gc = q._forcingPlayhead = q._hasPause = !1, q.to = function(a, b, d, e) { var f = d.repeat && l.TweenMax || c; return b ? this.add(new f(a, b, d), e) : this.set(a, d, e) }, q.from = function(a, b, d, e) { return this.add((d.repeat && l.TweenMax || c).from(a, b, d), e) }, q.fromTo = function(a, b, d, e, f) { var g = e.repeat && l.TweenMax || c; return b ? this.add(g.fromTo(a, b, d, e), f) : this.set(a, e, f) }, q.staggerTo = function(a, b, e, f, g, i, j, k) {
                ...
                var d = function(b) { a.call(this, b), this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._cycle = 0, this._yoyo = this.vars.yoyo === !0, this._dirty = !0 },
                    ...
                    j = d.prototype = new a;
                return j.constructor = d, j.kill()._gc = !1, d.version = "1.18.4", j.invalidate = function() { return this._yoyo = this.vars.yoyo === !0, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._uncache(!0), a.prototype.invalidate.call(this) }, j.addCallback = function(a, c, d, e) { return this.add(b.delayedCall(0, a, d, e), c) }, j.removeCallback = function(a, b) {
                    if (a)
            ...
            function() {
                ...
                var xa, ya = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Na = P.getTransform = function(a, c, d, f) {
                        ...
                        return d && (a._gsTransform = n, n.svg && (xa && a.style[za] ? b.delayedCall(.001, function() { Ra(a.style, za) }) : !xa && a.getAttribute("transform") && b.delayedCall(.001, function() { a.removeAttribute("transform") }))), n
                    },
                    Oa = function(a) {
                        var b, c, d = this.data,
                            e = -d.rotation * I,
...
function hack_all() {
    if (hackall == true) {
        hack();
        setTimeout(hack_all, parseInt(Math.random() * 500));
    } else {
        $('.info').remove();
        setTimeout(function() {
...
function zoom_out() {
    ...
    setTimeout(function() {
        ...
        $('#bgvid').append('<source src="//www.slavehack2.com/dreamscene.mp4" type="video/mp4">');
    }, 2700);
    setTimeout(function() {
...
function show_login() {
    ...
    $('#login-button').html(`
        <center style="display:block;">
          <button id="submit_login" class="btn btn-primary" style="margin-left: -62px;" type="button">Start Hacking</button>
        </center>
      `);
...
setInterval(function() {
    document.querySelector('h1').style.transform = 'scale(2.5)';
